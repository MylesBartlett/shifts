...
_TRAJECTORY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='points',
            full_name='neurips_dataset.Trajectory.points',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_WEIGHTEDTRAJECTORY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='trajectory',
            full_name='neurips_dataset.WeightedTrajectory.trajectory',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='weight',
            full_name='neurips_dataset.WeightedTrajectory.weight',
            index=1,
            number=2,
            type=2,
            cpp_type=6,
...
_OBJECTPREDICTION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='track_id',
            full_name='neurips_dataset.ObjectPrediction.track_id',
            index=0,
            number=1,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            name='scene_id',
            full_name='neurips_dataset.ObjectPrediction.scene_id',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='weighted_trajectories',
            full_name='neurips_dataset.ObjectPrediction.weighted_trajectories',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='neurips_dataset.ObjectPrediction.uncertainty_measure',
            index=3,
            number=4,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name='is_ood',
            full_name='neurips_dataset.ObjectPrediction.is_ood',
            index=4,
            number=5,
            type=8,
            cpp_type=7,
...
_SUBMISSION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='predictions',
            full_name='neurips_dataset.Submission.predictions',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
WeightedTrajectory = _reflection.GeneratedProtocolMessageType(
    'WeightedTrajectory',
    (_message.Message,),
    {
...
ObjectPrediction = _reflection.GeneratedProtocolMessageType(
    'ObjectPrediction',
    (_message.Message,),
    {
