...
def init_rip(c):
    ...
    print(
        f'Building RIP agent with backbone model {model_name}, '
    ...
    return (
        RIPAgent(models=models, **ensemble_kwargs),
        full_model_name,
        evaluate_step_rip,
        evaluate_step_rip,
    )
...
BACKBONE_NAME_TO_KWARGS_FN = {'bc': get_bc_kwargs, 'dim': get_dim_kwargs}
...
BACKBONE_NAME_TO_FULL_NAME = {'bc': 'Behavioral Cloning', 'dim': 'Deep Imitative Model'}
