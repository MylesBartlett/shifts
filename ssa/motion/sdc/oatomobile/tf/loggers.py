...
class TensorBoardLogger:
    ...
    def __init__(self, log_dir: str, dataset_names: List[str]) -> None:
        ...
        for dataset_name in dataset_names:
            ...
            self.__setattr__(
                f'summary_writer_{dataset_name}', tf.summary.create_file_writer(dataset_log_dir)
            )
    ...
    def log(
        ...
        with summary_writer.as_default():
            ...
            for _, (o_t, p_t, g_t,) in enumerate(
                ...
                ax = plt.gca()
                ax.add_collection(mc.LineCollection([g_t], color='green'))
                ax.add_collection(mc.LineCollection([p_t], color='blue'))
                ax.legend()
