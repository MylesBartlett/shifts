...
class WandbLogger:
    ...
    def log(self, dataset_split_to_loss_dict: Dict[str, Dict[str, torch.Tensor]], steps, epoch):
        # Construct loggable dict
        wandb_loss_dict = self.construct_loggable_dict(dataset_split_to_loss_dict)
        ...
        wandb_loss_dict['checkpoint_time'] = f'{time.time() - self.checkpoint_start:.3f}'
            ...
            for key, value in loss_dict.items():
                ...
                if type(value) == dict:
                    for key2, value2 in value.items():
                        ...
                        wandb_loss_dict[joint_key] = WandbLogger.safe_torch_to_float(value2)
                else:
                    wandb_loss_dict[key] = WandbLogger.safe_torch_to_float(value)
