...
def build_parser():
    ...
    ###########################################################################
    parser.add_argument(
        '--wandb_project', type=str, default='sdc-debug', help='Wandb project name.'
    )
    ...
    ###########################################################################
    parser.add_argument(
        '--dir_wandb', type=str, default='./', help='Directory to which wandb logs.'
    )
    parser.add_argument(
        '--dir_tensorboard', type=str, default='tb', help='Directory to which TensorBoard logs.'
    )
    parser.add_argument(
        '--dir_data',
        type=str,
    ...
    ###########################################################################
    parser.add_argument(
        '--verbose', type='bool', default=False, help='Extra logging, sanity checks.'
    )
    parser.add_argument(
        '--tb_logging',
        type='bool',
    ...
    parser.add_argument('--torch_seed', type=int, default=42, help='Model seed.')
    ...
    parser.add_argument(
        ...
        default='float32',
        type=str,
        help='Data type (supported for float32, float64) '
        'used for data (e.g. inputs, ground truth).',
    )
    parser.add_argument(
        '--data_use_prerendered', default=False, type='bool', help='Use pre-rendered data.'
    )
    ...
    parser.add_argument(
        '--exp_print_every_nth_forward',
        dest='exp_print_every_nth_forward',
        default=False,
        type=int,
        help='Print during mini-batch as well for large epochs.',
    )
    parser.add_argument('--exp_lr', type=float, default=1e-3)
    parser.add_argument('--exp_num_lr_warmup_epochs', type=int, default=1)
    parser.add_argument('--exp_batch_size', type=int, default=512)
    parser.add_argument('--exp_num_epochs', type=int, default=100)
    parser.add_argument(
        '--exp_image_downsize_hw',
        type=int,
        default=None,
    ...
    parser.add_argument(
        '--model_in_channels', type=int, default=17, help="Number of feature map channels."
    )
    parser.add_argument(
        '--model_output_shape',
        type=tuple,
    ...
    parser.add_argument(
        '--model_clip_gradients', type='bool', default=False, help='Clips gradients to 1.0.'
    )
    ...
    parser.add_argument(
        '--rip_k', type=int, default=3, help="Number of models in the RIP ensemble."
    )
    parser.add_argument(
