...
def dense_layer(
    ...
    layer_input = out if linear_first else inp
    layers = [nn.BatchNorm1d(layer_input)] if bn else []
    if p != 0:
...
class TabMlp(nn.Module):
    ...
    def __init__(
        ...
        embed_input: list[tuple[str, int, int]] | None = None,
        ...
        self.mlp_hidden_dims = mlp_hidden_dims if mlp_hidden_dims is not None else [200, 100]
