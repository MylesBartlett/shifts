...
__all__ = ["SpectralNormFC", "spectral_norm_fc"]
...
class SpectralNormFC(SpectralNorm):
    def __init__(
        ...
        super().__init__(name=name, dim=dim, n_power_iterations=n_power_iterations, eps=eps)
        self.coeff = coeff
    ...
    def apply(
        ...
        fn = cls(name, n_power_iterations, dim, eps)
        fn.coeff = coeff
