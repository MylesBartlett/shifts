...
__all__ = ["BatchNormSN1d", "BatchNormSN2d", "BatchNormSN3d"]


class _BatchNormSN(_NormBase):
    def __init__(
        self,
        num_features: int,
        coeff: float,
        ...
        momentum: float = 0.01,
        affine: bool = True,
    ) -> None:  # more momentum by default here than standard bn
        # remove the option to not track running stats, as we want these
        super(_BatchNormSN, self).__init__(
...
class BatchNormSN1d(_BatchNormSN, nn.BatchNorm1d):
    ...


class BatchNormSN2d(_BatchNormSN, nn.BatchNorm2d):
    ...


class BatchNormSN3d(_BatchNormSN, nn.BatchNorm3d):
    ...
